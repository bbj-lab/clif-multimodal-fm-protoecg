...
@label(name="hyperkalemia", token="LABEL//hyperkalemia", category="clif_only",
       description="Potassium > 6.0", source_tables=["clif_labs"])
...
@label(name="severe_hyperkalemia", token="LABEL//severe_hyperkalemia", category="clif_only",
       description="Potassium > 6.5", source_tables=["clif_labs"])
def compute_severe_hyperkalemia(hosp_row: dict, tables: dict, **kw) -> dict | None:
    return _first_lab_above(hosp_row, tables, "potassium", 6.5, "LABEL//severe_hyperkalemia")


@label(name="hypoglycemia", token="LABEL//hypoglycemia", category="clif_only",
       description="Glucose < 50", source_tables=["clif_labs"])
...
@label(name="severe_anemia", token="LABEL//severe_anemia", category="clif_only",
       description="Hemoglobin < 7", source_tables=["clif_labs"])
...
@label(name="thrombocytopenia", token="LABEL//thrombocytopenia", category="clif_only",
       description="Platelets < 50000", source_tables=["clif_labs"])
def compute_thrombocytopenia(hosp_row: dict, tables: dict, **kw) -> dict | None:
    return _first_lab_below(hosp_row, tables, "platelets", 50000, "LABEL//thrombocytopenia")


@label(name="lactate_elevated", token="LABEL//lactate_elevated", category="clif_only",
       description="Lactate > 2.0", source_tables=["clif_labs"])
...
@label(name="lactate_severe", token="LABEL//lactate_severe", category="clif_only",
       description="Lactate > 4.0", source_tables=["clif_labs"])
...
@label(name="coagulopathy", token="LABEL//coagulopathy", category="clif_only",
       description="INR > 2.0", source_tables=["clif_labs"])
...
@label(name="acidosis", token="LABEL//acidosis", category="clif_only",
       description="pH < 7.25", source_tables=["clif_labs"])
def compute_acidosis(hosp_row: dict, tables: dict, **kw) -> dict | None:
    return _first_lab_below(hosp_row, tables, "ph", 7.25, "LABEL//acidosis")


@label(name="creatinine_rise", token="LABEL//creatinine_rise", category="clif_only",
       description="Creatinine >= 1.5x baseline", source_tables=["clif_labs"])
def compute_creatinine_rise(hosp_row: dict, tables: dict, **kw) -> dict | None:
    ...
    if len(elevated) > 0:
        return {"code": "LABEL//creatinine_rise", "time": elevated[0, "lab_result_dttm"]}
    return None


@label(name="troponin_elevated", token="LABEL//troponin_elevated", category="clif_only",
...
@label(name="bnp_elevated", token="LABEL//bnp_elevated", category="clif_only",
       description="BNP > 300 pg/mL", source_tables=["clif_labs"])
def compute_bnp_elevated(hosp_row: dict, tables: dict, **kw) -> dict | None:
    return _first_lab_above(hosp_row, tables, "bnp", 300, "LABEL//bnp_elevated")
