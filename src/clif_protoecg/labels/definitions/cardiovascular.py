...
@label(name="vasopressor", token="LABEL//vasopressor", category="clif_only",
...
@label(name="hypotension", token="LABEL//hypotension", category="clif_only",
       description="MAP < 65 mmHg", source_tables=["clif_vitals"])
...
@label(name="tachycardia", token="LABEL//tachycardia", category="clif_only",
       description="Heart rate > 120", source_tables=["clif_vitals"])
...
@label(name="bradycardia", token="LABEL//bradycardia", category="clif_only",
       description="Heart rate < 50", source_tables=["clif_vitals"])
...
@label(name="ecmo", token="LABEL//ecmo", category="clif_only",
       description="ECMO initiation", source_tables=["clif_ecmo_mcs"])
